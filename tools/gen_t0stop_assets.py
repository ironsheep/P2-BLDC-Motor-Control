...
ACTION_TEXTS = [
    ...
    "SPIN THE %s BRISKLY BY HAND, THEN LET GO. YOU SHOULD FEEL IT SPIN FREELY AND COAST TO A STOP -- THE WHEEL TIMES ITSELF. CLICK DONE ONCE IT LOOKS STOPPED." % WHEEL_TEXT,
    "SPIN THE %s BRISKLY BY HAND, THEN LET GO. YOU SHOULD FEEL IT RESIST HARDER THE FASTER IT TURNS, THEN STOP QUICKLY -- THE WHEEL TIMES ITSELF. CLICK DONE ONCE IT LOOKS STOPPED." % WHEEL_TEXT,
