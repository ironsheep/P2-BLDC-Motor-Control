...
| R2-T0-EMPTY | T0 | T0-14c testSetup(PINS_P0_P15) | EMPTY_NODET | TRUE | TRUE | BOOL | 1 | - | M | 1 | OWED | - | COVERAGE, not a falsifier: empty group P0_P15 read sum 500 and was not detected (2026-09-11/debug_260911-210229.log:81-125), and that log predates the 3500 fix, so the unfixed code already passes; since the task 3537 T0 follow-ups an aborted testSetup() prints NOMEAS rather than reading REV_Unknown as a pass (arbiter review 2026-09-14) |
